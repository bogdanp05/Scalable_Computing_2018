...
deploy:
	...
	@echo ${KAFKA_IP}
	${SPARK_HOME}/bin/spark-submit --class nl.rug.sc.app.SparkSubmitMain --deploy-mode client --master spark://${MASTER_IP}:7077 ./Project/target/scala-2.11/Project-assembly-0.1.jar ${MONGO_IP} $(KAFKA_IP) true
